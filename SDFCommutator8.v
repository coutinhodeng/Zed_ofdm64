// -------------------------------------------------------------
// 
// File Name: D:\OFDM- HDL\simulation\baseband\v8\src\Tx\Zed_ofdm64\SDFCommutator8.v
...
// Source Path: dsphdl.IFFT/RADIX22FFT_SDF2_8/SDFCommutator8
// Hierarchy Level: 4
// Model version: 3.61
// 
// -------------------------------------------------------------
...
module SDFCommutator8
  ...
  input   enb_1_1_1;
  input   dout_7_1_vld;
  input   signed [31:0] xf_re;  // sfix32_En8
  input   signed [31:0] xf_im;  // sfix32_En8
  input   xf_vld;
  input   signed [31:0] dinf_re;  // sfix32_En8
  input   signed [31:0] dinf_im;  // sfix32_En8
  input   dinf_vld;
  input   signed [31:0] btf1_re;  // sfix32_En8
  input   signed [31:0] btf1_im;  // sfix32_En8
  input   signed [31:0] btf2_re;  // sfix32_En8
  input   signed [31:0] btf2_im;  // sfix32_En8
  input   btfout_vld;
  output  signed [31:0] wrData_re;  // sfix32_En8
  output  signed [31:0] wrData_im;  // sfix32_En8
  output  wrAddr;  // ufix1
  output  wrEnb;
  ...
  reg signed [31:0] SDFCummutator_out_re;  // sfix32
  reg signed [31:0] SDFCummutator_out_im;  // sfix32
  reg  SDFCummutator_out_vld;
  reg  SDFCummutator_wrAddr_reg;  // ufix1
  reg [2:0] SDFCummutator_wrState;  // ufix3
  reg signed [31:0] SDFCummutator_wrData_re_reg;  // sfix32
  reg signed [31:0] SDFCummutator_wrData_im_reg;  // sfix32
  reg  SDFCummutator_wrEnb_reg;
  reg signed [31:0] SDFCummutator_wrXData_re_reg;  // sfix32
  reg signed [31:0] SDFCummutator_wrXData_im_reg;  // sfix32
  ...
  reg signed [31:0] SDFCummutator_btf1_re_dly;  // sfix32
  reg signed [31:0] SDFCummutator_btf1_im_dly;  // sfix32
  reg  SDFCummutator_btf1_vld_dly;
  reg signed [31:0] SDFCummutator_out_re_next;  // sfix32_En8
  reg signed [31:0] SDFCummutator_out_im_next;  // sfix32_En8
  reg  SDFCummutator_out_vld_next;
  reg  SDFCummutator_wrAddr_reg_next;  // ufix1
  reg [2:0] SDFCummutator_wrState_next;  // ufix3
  reg signed [31:0] SDFCummutator_wrData_re_reg_next;  // sfix32_En8
  reg signed [31:0] SDFCummutator_wrData_im_reg_next;  // sfix32_En8
  reg  SDFCummutator_wrEnb_reg_next;
  reg signed [31:0] SDFCummutator_wrXData_re_reg_next;  // sfix32_En8
  reg signed [31:0] SDFCummutator_wrXData_im_reg_next;  // sfix32_En8
  ...
  reg signed [31:0] SDFCummutator_btf1_re_dly_next;  // sfix32_En8
  reg signed [31:0] SDFCummutator_btf1_im_dly_next;  // sfix32_En8
  reg  SDFCummutator_btf1_vld_dly_next;
  reg signed [31:0] wrData_re_1;  // sfix32_En8
  reg signed [31:0] wrData_im_1;  // sfix32_En8
  reg  wrAddr_1;  // ufix1
  reg  wrEnb_1;
  reg signed [31:0] xData_re;  // sfix32_En8
  reg signed [31:0] xData_im;  // sfix32_En8
  reg [2:0] wrXAddr;  // ufix3
  reg  wrXEnb;
  reg [2:0] rdXAddr;  // ufix3
  reg  xX_vld;
  reg signed [31:0] dout0_re;  // sfix32_En8
  reg signed [31:0] dout0_im;  // sfix32_En8
  reg  dout0_vld;
  wire signed [31:0] xX_re;  // sfix32_En8
  wire signed [31:0] xX_im;  // sfix32_En8
  reg signed [31:0] SDFOutmux_btf2Pipe_re;  // sfix32
  reg signed [31:0] SDFOutmux_btf2Pipe_im;  // sfix32
  reg  SDFOutmux_btfPipe_vld;
  reg signed [31:0] SDFOutmux_btf2Pipe_re_next;  // sfix32_En8
  reg signed [31:0] SDFOutmux_btf2Pipe_im_next;  // sfix32_En8
  reg  SDFOutmux_btfPipe_vld_next;
  reg signed [31:0] dout_8_1_re_1;  // sfix32_En8
  reg signed [31:0] dout_8_1_im_1;  // sfix32_En8
  reg  dout_8_1_vld_1;
  ...
  always @(posedge clk or posedge reset)
    begin : SDFCummutator_process
      if (reset == 1'b1) begin
        SDFCummutator_out_re <= 32'sb00000000000000000000000000000000;
        SDFCummutator_out_im <= 32'sb00000000000000000000000000000000;
        SDFCummutator_wrData_re_reg <= 32'sb00000000000000000000000000000000;
        SDFCummutator_wrData_im_reg <= 32'sb00000000000000000000000000000000;
        SDFCummutator_wrEnb_reg <= 1'b0;
        SDFCummutator_out_vld <= 1'b0;
        SDFCummutator_wrState <= 3'b000;
        SDFCummutator_wrAddr_reg <= 1'b0;
        SDFCummutator_wrXData_re_reg <= 32'sb00000000000000000000000000000000;
        SDFCummutator_wrXData_im_reg <= 32'sb00000000000000000000000000000000;
        ...
        SDFCummutator_btf1_re_dly <= 32'sb00000000000000000000000000000000;
        SDFCummutator_btf1_im_dly <= 32'sb00000000000000000000000000000000;
  ...
  always @(SDFCummutator_XState, SDFCummutator_btf1_im_dly, SDFCummutator_btf1_re_dly,
    ...
    case ( SDFCummutator_XState)
      ...
      default :
        begin
          SDFCummutator_wrXData_re_reg_next = 32'sb00000000000000000000000000000000;
          SDFCummutator_wrXData_im_reg_next = 32'sb00000000000000000000000000000000;
          SDFCummutator_xWrAddr_next = 3'b000;
          SDFCummutator_xRdAddr_next = 3'b000;
          SDFCummutator_wrxEnb_reg_next = 1'b0;
          SDFCummutator_XState_next = 3'b000;
  ...
  dataMEM_re_0_1_Wrapper_generic #(.AddrWidth(3),
                                 ...
                                 u_dataXMEM_re_0_8_Wrapper (.clk(clk),
                                                            .reset(reset),
                                                            .enb(enb),
                                                            .enb_1_1_1(enb_1_1_1),
                                                            .wr_din(xData_re),
  ...
  dataMEM_re_0_1_Wrapper_generic #(.AddrWidth(3),
                                 ...
                                 u_dataXMEM_im_0_8_Wrapper (.clk(clk),
                                                            .reset(reset),
                                                            .enb(enb),
                                                            .enb_1_1_1(enb_1_1_1),
                                                            .wr_din(xData_im),
  ...
  always @(posedge clk or posedge reset)
    begin : SDFOutmux_process
      if (reset == 1'b1) begin
        SDFOutmux_btf2Pipe_re <= 32'sb00000000000000000000000000000000;
        SDFOutmux_btf2Pipe_im <= 32'sb00000000000000000000000000000000;
